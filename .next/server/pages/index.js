...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Victor-Adewoye:XpjAblXby2SNSS51@cluster0.pbrj5kl.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); // getstaticprops is a usefull function thats helps your pre rendered page get data it might need to wait for
